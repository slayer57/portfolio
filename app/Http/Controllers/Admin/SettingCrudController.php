...
class SettingCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('phone');
        CRUD::column('address');
        CRUD::column('avatar')->type('image')->label('Avatar');
        CRUD::column('link');
        CRUD::column('icon');
        CRUD::column('order');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('address')->label('Address');
        CRUD::field('avatar')->label('Avatar')->type('upload')->upload(true)->disk('public')->withFiles();
        CRUD::field('link');
        CRUD::field('icon');
        CRUD::field('order');
